...
md"Scaling factors for GP variance: $(@bind smooth_factor_var Slider(0.05:0.05:5; default=1.0, show_value=true))   & length scale $(@bind smooth_factor_length Slider(0.05:0.05:4; default=1.0, show_value=true))"
